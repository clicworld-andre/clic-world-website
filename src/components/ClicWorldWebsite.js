...
const ClicWorldWebsite = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section id="pryvaz" className="section-padding bg-gradient-to-r from-blue-700 to-blue-800 text-white">
        <div className="container-custom">
      ...
      {/* Contact Section */}
      <section id="contact" className="section-padding bg-gradient-to-r from-blue-700 to-blue-800 text-white">
        <div className="container-custom">
          <div className="text-center mb-16">
